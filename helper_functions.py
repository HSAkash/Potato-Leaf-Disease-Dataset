...
def getBestWeightModel(model, weightPath):
  """clone the model"""
  cp_model = tf.keras.models.clone_model(model)
  """Compile the model"""
  cp_model.compile(
...
def saveBestWeightModel(model, weightPath, distination, fileName=None):
  if fileName:
    distination = os.path.join(distination, fileName)
  """clone the model"""
  cp_model = tf.keras.models.clone_model(model)
  """Compile the model"""
  cp_model.compile(
